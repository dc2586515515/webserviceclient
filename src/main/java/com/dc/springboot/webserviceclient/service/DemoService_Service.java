 ...
 * 
 */
@WebServiceClient(name = "DemoService", targetNamespace = "http://service.webservice.springboot.dc.com", wsdlLocation = "http://localhost:8090/demo/api?wsdl")
    ...
    extends Service
{
    ...
    private final static QName DEMOSERVICE_QNAME = new QName("http://service.webservice.springboot.dc.com", "DemoService");
    ...
    public DemoService getDemoServiceImplPort() {
        return super.getPort(new QName("http://service.webservice.springboot.dc.com", "DemoServiceImplPort"), DemoService.class);
    }
    ...
    public DemoService getDemoServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.webservice.springboot.dc.com", "DemoServiceImplPort"), DemoService.class, features);
    }
